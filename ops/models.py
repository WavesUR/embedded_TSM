...
class TSN(nn.Module):
    ...
    def _prepare_tsn(self, num_class):
        if(isinstance(self.base_model, MobileNetV2)):
            last_layer = getattr(self.base_model, self.base_model.last_layer_name)
            feature_dim = list(last_layer.children())[1].in_features
        else:
    ...
    def _prepare_base_model(self, base_model):
        ...
        if 'resnet' in base_model:
            ...
            state_dict = torch.load('./pretrained/mobilenet_v2.pth.tar')
